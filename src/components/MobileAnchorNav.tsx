          ...
          >
            {anchors.map((a, i) => {
              ...
              return (
                <div
                  key={a.href}
                  className={`whitespace-nowrap uppercase font-[family-name:var(--font-body)] font-semibold text-[16px] leading-normal rounded-[4px] border p-[4px] transition-colors duration-100 ${
                    isSelected
