...
export default function MobileAnchorNav({
  ...
  return (
    <>
      {/* Blocks interaction with (and selection of) everything behind the menu
          while a drag is in progress. Rendered outside the translated wrapper
          ...
          >
            {anchors.map((a, i) => {
              ...
              return (
                <div
                  key={a.href}
                  className={`whitespace-nowrap uppercase font-[family-name:var(--font-body)] text-[14px] leading-normal rounded-[4px] border p-[4px] transition-colors duration-100 ${
                    isSelected
