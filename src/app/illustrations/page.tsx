        ...
        <div className="max-w-[1440px] mx-auto flex flex-col gap-[40px] px-4 md:px-[120px]">
          ...
          <div className="flex flex-col md:flex-row gap-[40px] items-start">
            ...
            <div className="flex-1">
              <img src={asset(i(31))} alt="" className="w-full h-[810px] object-cover" />
            </div>
          </div>
          ...
          <div>
            <img src={asset(i(10))} alt="" className="w-full h-[607px] object-cover" />
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-[40px] items-start">
            ...
            <div className="flex-1">
              <img src={asset(i(17))} alt="" className="w-full h-[810px] object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-[40px] items-start">
            ...
            <div className="flex-1">
              <img src={asset(i(33))} alt="" className="w-full h-[810px] object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-[40px] items-start">
            ...
            <div className="flex-1">
              <img src={asset(i(25))} alt="" className="w-full h-[810px] object-cover" />
            </div>
          </div>
