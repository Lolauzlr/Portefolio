    ...
    <div className="pt-[95px] bg-[#15161b] text-white min-h-screen">
      ...
      <section className="relative h-[810px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 md:left-[120px] bg-[#15161b]/80 backdrop-blur-sm p-8 max-w-lg">
          <p className="text-base font-[family-name:var(--font-body)] tracking-[1.28px] text-[#0fd1ea] uppercase mb-2">
            Trailer
          </p>
          <h1 className="text-[40px] md:text-[80px] font-[family-name:var(--font-heading)] tracking-[6.4px] leading-tight">
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            {["2025", "Jeu vidéo", "Action aventure", "2D"].map((tag) => (
              <span
                key={tag}
                className="border border-white/30 px-4 py-1 text-[20px] tracking-[1.6px] font-[family-name:var(--font-body)] rounded-full"
              >
                {tag}
              </span>
            ))}
        ...
        <div className="flex gap-6 overflow-x-auto pb-4">
          {recentTrailers.map((card) => (
            <div key={card.title} className="flex-shrink-0">
              ...
              />
              <p className="mt-3 text-[24px] font-[family-name:var(--font-heading)] tracking-[1.92px]">
                {card.title}
              </p>
            </div>
          ))}
